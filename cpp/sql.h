 ...
 * All rights reserved. 
 * Copyright (C) 1990-1995 By Microsoft Corp.
 * All rights reserved.
 *
...
#define SQL_SQLSTATE_SIZE                 5U    /* size of SQLSTATE */
#define SQL_MAX_MESSAGE_LENGTH          512U    /* message buffer size */
#define SQL_MAX_DSN_LENGTH               32U    /* maximum data source name size*/
...
/* SQL_NOSCAN options */
#define SQL_NOSCAN_OFF                  0     /*      1.0 FALSE */
#define SQL_NOSCAN_ON                   1     /*      1.0 TRUE */
...
#define SQL_SCROLL_FORWARD_ONLY         0    /*-SQL_CURSOR_FORWARD_ONLY */
#define SQL_SCROLL_KEYSET_DRIVEN        (-1) /*-SQL_CURSOR_KEYSET_DRIVEN */
#define SQL_SCROLL_DYNAMIC              (-2) /*-SQL_CURSOR_DYNAMIC */
#if (ODBCVER >= 0x0200)
#define SQL_SCROLL_STATIC               (-3) /*-SQL_CURSOR_STATIC */
